...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STRIPE_SECRET_KEY" | "STRIPE_PRICE_ID_ONE_TIME_PAYMENT" | "STRIPE_PRICE_ID_SUBSCRIPTION" | "STRIPE_PRICE_ID_USAGE_BASED_SUBSCRIPTION">> {}
}
