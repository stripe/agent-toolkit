/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3dddd673e29cd106316b3b4ab1f7a489)
...
declare namespace Cloudflare {
	interface Env {
		...
		STRIPE_ONETIME_SUBSCRIPTION_PRICE_ID: string;
		STRIPE_USAGE_BASED_SUBSCRIPTION_PRICE_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STRIPE_SECRET_KEY" | "STRIPE_ONETIME_SUBSCRIPTION_PRICE_ID" | "STRIPE_USAGE_BASED_SUBSCRIPTION_PRICE_ID" | "STRIPE_METER_EVENT_NAME">> {}
}
