...
async function sampleResponsesAPIParse() {  
  ...
  const response = await openai.responses.parse({
    ...
    instructions: 'You are a helpful math assistant. Provide the answer and a brief explanation.',
    text: {
      format: {
        type: 'json_schema',
        name: 'math_response',
...
async function runAllSamples() {
  ...
  console.log('These examples show how to use TrackedOpenAI with Stripe billing\n')
